...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            ...
            <a href="#" class="small mr-3"><span class="icon-phone2 mr-2"></span> (0263) 325749</a> 
            <a href="#" class="small mr-3"><span class="icon-envelope-o mr-2"></span>YayasanNurulIsalam@gmail.com</a> 
          </div>
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.html" class="d-block">
              <img src="{{asset('/assets/img/Logo_Yayasan.png')}}" width="90px" height="90px" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="teachers.html">Sejarah</a></li>
                    <li><a href="about.html">Visi dan Misi</a></li>
                    <li><a href="teachers.html">Organigram</a></li>
                    <li><a href="teachers.html">Sarana Prasarana</a></li>
                  </ul>
                </li>
                <li class="has-children">
                  <a href="about.html" class="nav-link text-left">Program dan Layanan</a>
                  <ul class="dropdown">
                    <li><a href="teachers.html">Pondok Pesantren</a></li>
                    <li><a href="about.html">Madrasah Tsanahwiyah(MTS)</a></li>
                    <li><a href="teachers.html">Madrasah Aliyah(MA)</a></li>
                    <li><a href="teachers.html">Sekolah Menengah Kejuruan(SMK)</a></li>
                  </ul>
                </li>
                <li class="has-children">
                  <a href="about.html" class="nav-link text-left">Galeri</a>
                  <ul class="dropdown">
                    <li><a href="teachers.html">Photo</a></li>
                    <li><a href="about.html">Video</a></li>
                  </ul>
                </li>
            
                  <a href="courses.html" class="nav-link text-left">Blog</a>
                </li>
                <li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('/assets/img/awal.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
<h1>Login</h1>
                <h3>Ilmu yang memberdayakan, Pendidikan yang mencerahkan</h3>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="site-section">
        <div class="container">
            ...
            <div class="row justify-content-center" action="{{route('login')}}" method="POST">
                @csrf  
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="password" id="pword" ame="password" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
