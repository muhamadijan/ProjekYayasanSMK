...
<div class="main-content">
    <section class="section">
        <div class="section-header">
                <h1>Tambah Sambutan Kepala yayasan</h1>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Tambah Sambutan Kepala yayasan</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('profil.kepala-yayasan.post') }}" method="POST" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Masukkan nama Kepala yayasan" class="form-control @error('judul') is-invalid @enderror">
