...
<div class="main-content">
    <section class="section">
        <div class="section-header">
                <h1>Edit Sambutan Kepala yayasan</h1>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Edit Sambutan Kepala yayasan</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('profil.kepala-yayasan.post') }}" method="POST" enctype="multipart/form-data"> 
                            @csrf
                            <input type="hidden" name="id" value="{{$sambutan->id}}">
                            <div class="form-group">
                                <label>NAMA KEPALA yayasan</label>
                                <input type="text" name="judul" value="{{$sambutan->judul}}" placeholder="Masukkan nama kepala yayasan" class="form-control @error('judul') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                <label for="">ISI Sambutan Kepala yayasan</label>
