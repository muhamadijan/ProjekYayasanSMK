            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(count($strukturs) == 0)
                        <div class="row">
                            <a href="{{route('profil/struktur-organisasi/create')}}" class="btn btn-primary  mb-4"><i class="fas fa-plus-circle"></i> Apload  Struktur Organisasi</a>&nbsp;
                            @endif   </div>    
                    </div>
                            ...
                            @foreach ($strukturs as $no => $struktur)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('profil.struktur-organisasi.edit', $struktur->id) }}" class="btn btn-sm btn-primary">
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "/profil/struktur-organisasi/index/delete/"+id,
                        data:     {
                            "id": id,
                            "_token": token
                        },
