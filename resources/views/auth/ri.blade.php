    ...
    <style>
        ...
        * {
        ...
        .box {
            ...
            background: url('/image/logo/log.png');
...
<body>
    ...
    <div class="box">
		<form class="login-form" action="{{route('login')}}" method="POST">
            <center>
                <img src="{{asset('image/logo/g.png')}}" alt="" class="img img-thumbnail border-0" width="250">
            </center>

			<h1 class="font-login">SISTEM OPRASI INFORMATIKA</h1>
                @csrf           
