...
<br><br><br><br>
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Photo</span>
      </div>
    </div>

    <div class="container pt-5 mb-5">
        <h2 class="section-title-underline text-center mb-4">
            <span>Foto-Foto Yayasan Nurul Islam Affandiyyah</span>
        </h2>
            ...
            @foreach($galeri as $galeri)
                <div class="col-md-4 mb-4">
                    <div class="card h-100" style="width: 100%;">
                        <img src="{{ asset('/image/' . $galeri->gamar) }}" class="card-img-top" alt="Foto Yayasan">
                        <div class="card-body text-center">
                            <p class="card-text font-weight-bold">{{ $galeri->judul }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
