...
<br><br><br><br>
    ...
    <div class="container pt-5 mb-5">
        <h2 class="section-title-underline text-center mb-4">
            <span>Berita Yayasan Nurul Islam Affandiyyah</span>
        </h2>
            ...
            @foreach($berita as $berita)
                <div class="col-md-4 mb-4">
                    <div class="card h-100" style="width: 100%;">
                        <img src="{{ asset('/image/' . $berita->gambar) }}" class="card-img-top" alt="Foto Yayasan">
                        <div class="card-body text-center">
                            <p class="card-text font-weight-bold">{{ $berita->judul }}</p>
                            <p class="card-text font-weight-bold">{!! $berita->isi !!}</p>
                        </div>
                    </div>
                </div>
            @endforeach
