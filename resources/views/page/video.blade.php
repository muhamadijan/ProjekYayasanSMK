...
<br><br><br><br>
    ...
    <div class="container pt-5 mb-5">
        <h2 class="section-title-underline text-center mb-4">
            <span>Video Yayasan Nurul Islam Affandiyyah</span>
        </h2>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100" style="width: 100%;">
                        <video class="card-img-top" controls autoplay loop muted>
                            <source src="{{ asset('/image/' . $video->video) }}" type="video/mp4">
                            Browser Anda tidak mendukung tag video.
                        </video>
                        <div class="card-body text-center">
                            <p class="card-text font-weight-bold">{{ $video->judul }}</p>
                              <p class="card-text font-weight-bold">{!! $video->isi !!}</p>
                        </div>
                    </div>
                </div>
            @endforeach
