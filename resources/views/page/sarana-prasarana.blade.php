...
<br><br><br><br>
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Sarana Prasarana</span>
      </div>
    </div>
    <div class="container pt-5 mb-5">
        <h2 class="section-title-underline text-center mb-4">
            <span>Sarana Prasarana Yayasan Nurul Islam Affandiyyah</span>
        </h2>
    
        <table class="table table-bordered" id="sarana">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($sarana as $index => $item)
                    <tr>
                        ...
                        <td>{{ $item->uraian }}</td>
                        <td>{{ $item->jumlah_ada }}</td>
                        <td>{{ $item->kondisi }}</td>
                        <td>{{ $item->jumlah_yg_diperlukan }}</td>
